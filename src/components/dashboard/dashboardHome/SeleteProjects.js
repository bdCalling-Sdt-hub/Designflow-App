      ...
      <div className="lg:grid grid-cols-3 my-5 md:gap-10 gap-5">
              ...
              <label className="rounded-2xl overflow-hidden relative cursor-pointer">
                ...
                <label className="inline-flex items-center cursor-pointer absolute top-5 left-5">
                  <input
                    ...
                    value="1"
                  />
                  <div className="w-10 h-10 flex items-center justify-center bg-transparent border-2 border-orange-500 rounded-full transition-all duration-300 ease-in-out
                          peer-checked:bg-orange-500 peer-checked:border-orange-500 peer-checked:scale-110">
                    <div className="w-6 h-6 bg-transparent rounded-full transition-all duration-300 ease-in-out
        ...
        <div>
          ...
          <div className="p-10 bg-[#f1f4f0] rounded-lg">
            <label className="mb-5 block w-full cursor-pointer">
              <input
                ...
                value="1"
              />
              <div className="w-full h-auto flex items-center justify-center bg-transparent  rounded-full transition-all duration-100 ease-in-out
                          peer-checked:bg-[#2e3c2a] peer-checked:border-[#2e3c2a] peer-checked:text-white font-semibold">
                <div className="w-full h-auto flex items-center gap-2 justify-start bg-transparent rounded-full transition-all text-center  duration-300 ease-in-out p-2
                            ">
          ...
          <div>
            ...
            <p className="bg-[#f1f4f0] p-10 rounded-lg">
              {" "}Lorem ipsum dolor sit amet, perfecto urbanitas ne qui, dicta
              commodo cu mei. Id eirmod alienum eloquentiam has. Saepe utamur
              vim in. Et adhuc intellegat vim. Elitr graecis mandamus cu eos.
              Dicta alienum sadipscing cu mel, at has elit putent feugait, iusto
              fierent persequeris eam et.
            </p>
