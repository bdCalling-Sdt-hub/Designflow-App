...
const Page = () => {
    return (
        <div className='md:mr-10 md:mx-0 mx-5'>
            <div className='flex justify-between items-center flex-wrap gap-10'>
                <Link href={'/'} className='flex items-center gap-5 text-2xl font-semibold'><FaArrowLeft />Designer List</Link>
                    ...
                    <tbody>
                        ...
                        <tr className="text-sm py-2  border-gray-200">
                            ...
                            <td className="px-4 py-2 text-center">
                                <Link href={'/dashboard/designers/sdf'} ><IoMdEye className='text-3xl' /></Link>
                            </td>
                        </tr>
            ...
            <div className='my-10 flex justify-end items-center gap-5 flex-wrap font-semibold'>
                <Link className='  px-20 rounded-md py-3 border text-[#637f5c] border-[#637f5c] ' href={'/dashboard/designers/removedesigner'}>Remove Designer</Link>
                <Link className='  px-20 rounded-md py-3 bg-[#637f5c] text-white ' href={'/dashboard/designers/adddesigner'}>Add Designer</Link>
            </div>
