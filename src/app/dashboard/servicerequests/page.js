...
const page = () => {
    return (
        <div className='my-10 md:mr-10 md:px-0 px-5'>
            ...
            <div className='mt-10 grid xl:grid-cols-3 gap-10 items-start'>
                <div className='border-2  rounded-md xl:col-span-2 overflow-hidden p-5'>
                    <Calendar ></Calendar>
                </div>
                <div className='xl:col-span-1 px-5 py-10 bg-gray-200 rounded-md'>
